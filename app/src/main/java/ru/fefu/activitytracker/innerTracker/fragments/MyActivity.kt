...
import ru.fefu.activitytracker.databinding.MyTaskFragmentBinding
...
class MyActivity : Fragment(R.layout.my_task_fragment) {
    private var _binding: MyTaskFragmentBinding? = null
    private val binding get() = _binding!!
    private val activitiesDate = mutableListOf<Any>()

    private val tasks = listOf(
        ActivityModel("10 км", "Пушечное ядро", LocalDateTime.now(), LocalDateTime.now()),
        ActivityModel("20 км", "Пушечная дробь", LocalDateTime.of(2020, 1, 1, 10, 0),
            LocalDateTime.of(2020, 1, 1, 20, 20),))
    ...
    override fun onCreateView(
        ...
        _binding = MyTaskFragmentBinding.inflate(inflater, container, false)
        return binding.root
    }
